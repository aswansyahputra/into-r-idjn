...
Anda tentu menyadari ada banyak hal yang harus dilakukan untuk membuat grafik tersebut menjadi lebih menarik serta mudah dimengerti. Sekarang tugas Anda adalah melakukan kostumisasi grafik tersebut sehingga dapat menyerupai grafik di bawah ini:

```{r}
knitr::include_graphics("asset/bob-ross-elements.png")
```

Berikut merupakan beberapa poin penting dan tugas kostumisasi grafik yang dapat Anda kerjakan:
